"""RIFE IFNet architecture (v4.0 - v4.26).

Vendored from Fannovel16/ComfyUI-Frame-Interpolation (MIT License):
https://github.com/Fannovel16/ComfyUI-Frame-Interpolation/blob/main/vfi_models/rife/rife_arch.py
which is in turn derived from:
https://github.com/hzwer/Practical-RIFE (MIT License)
https://github.com/HolyWu/vs-rife (MIT License)

Local modifications: removed ComfyUI/training-only imports; the warp() grid
cache now derives its device from the flow tensor instead of a global.
"""
import torch
